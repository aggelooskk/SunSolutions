    ...
    <>
      ...
      <div className="w-2/3 m-5 bg-white rounded-lg shadow-lg p-6 border border-gray-200">
        <p className="text-black mb-4">
          Πλαίσιο ηλιακού συλλέκτη από ειδικά σχεδιασμένο χυτό προφίλ
          αλουμινίου, επεξεργασμένο με ηλεκτροστατική βαφή φούρνου, χωρίς ραφές,
          βίδες κλπ, για απόλυτη στεγανότητα.
        </p>
        <ol className="list-decimal list-inside text-black space-y-4 ml-2">
          <li>
            Χάλκινος υδροσκελετός, επιλεκτικός (Τιτανίου-μπλε) με φύλλα
            αλουμινίου που εξασφαλίζουν ενιαία απορροφητική επιφάνεια και
            απίστευτα υψηλή απόδοση ακόμα και στις χειρότερες καιρικές συνθήκες.
          </li>
          <li>
            Ισχυρότατη μόνωση με πετροβάμβακα πάχους 40 mm (50kg/m³) στην πλάτη
            και 20 mm στα πλευρικά τοιχώματα του συλλέκτη περιορίζουν στο
            ελάχιστο τις θερμικές απώλειες, συμβάλλοντας στην υψηλή απόδοση.
          </li>
          <li>
          ...
          <li>
            ...
            επιτυγχάνοντας ταχύτατη εξάπλωση της θερμότητας και τέλεια προστασία
            κατά του παγετού και της οξείδωσης.
          </li>
        </ol>
      </div>
