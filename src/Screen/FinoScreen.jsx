    ...
    <>
      ...
      <div className="w-2/3 mx-5 mb-14 bg-white rounded-lg shadow-lg p-6 border border-gray-200">
        <div className="text-black space-y-4">
          <li>
            ...
            κατασκευαστεί με κύριο στόχο να εξασφαλίζει μεγάλη απόδοση, διάρκεια
            ζωής και διακριτική εμφάνιση.
          </li>
          <li>
          ...
          <li>
            Οι ηλιακοί θερμοσίφωνες EUROSTAR FINO κατασκευάζονται σύμφωνα με το
      ...
      <div className="w-2/3 m-5 bg-white rounded-lg shadow-lg p-6 border border-gray-200">
        <ol className="list-decimal list-inside text-black space-y-4 ml-2">
          ...
          <li>
            Ισχυρή μόνωση χυτής οικολογικής πολυουρεθάνης 5–7 cm, πυκνότητας 50
            kg/m³ με θερμομονωτικό συντελεστή 0.019 kcal/m/h/°C.
          </li>
          <li>
          ...
          <li>
            Boiler από ευρωπαϊκό χαλυβδοέλασμα με εσωτερική προστασία από εμαγιέ
            (860°C) για προστασία από σκληρά νερά.
          </li>
          <li>Ανοδική προστασία με ράβδο μαγνησίου κατά της ηλεκτρόλυσης.</li>
          <li>Ηλεκτρική αντίσταση 4kW για ζεστό νερό ακόμα και με συννεφιά.</li>
          <li>
      ...
      <div className="w-2/3 m-5 bg-white rounded-lg shadow-lg p-6 border border-gray-200">
        <ol className="list-decimal list-inside text-black space-y-4 ml-2">
          ...
          <li>
            Θερμικό υγρό προπυλενογλυκόλης με αντιδιαβρωτικά για ταχεία θέρμανση
            και αντοχή σε παγετό και οξείδωση.
          </li>
        </ol>
      </div>
