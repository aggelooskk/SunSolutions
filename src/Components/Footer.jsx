    ...
    <footer className="bg-gray-900 text-white pt-8 font-sans">
      <div className="text-center mb-6">
        ...
        <div className="flex justify-center space-x-4 text-white">
          ...
          />
          <FaGoogle size={24} className="hover:text-red-500 cursor-pointer" />
          <FaTiktok size={24} className="hover:text-pink-500 cursor-pointer" />
          <FaGithub size={24} className="hover:text-gray-400 cursor-pointer" />
        </div>
      </div>
